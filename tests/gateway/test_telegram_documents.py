...
class TestDocumentDownloadBlock:
    ...
    @pytest.mark.asyncio
    async def test_amr_document_is_routed_as_audio(self, adapter):
        """Cube ACR / Telegram .amr uploads should not be rejected as documents."""
    ...
    @pytest.mark.asyncio
    async def test_audio_mime_document_without_known_extension_is_routed_as_audio(self, adapter):
        """Telegram audio documents with odd filenames still get audio handling."""
